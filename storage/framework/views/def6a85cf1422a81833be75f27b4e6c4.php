                    ...
                    <div class=" mt-5 col col-lg-9 col-xl-8">
                        <div class="card">
                            ...
                            <div class="card-body p-4 text-black w-75 m-auto mt-5">
                                <form action="<?php echo e(route('updateProfile',$loginUser )); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <?php if(!isset($loginUser->position_id)): ?>
                                                <option value="" selected disabled>---</option>
                                            <?php endif; ?>                                            <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
