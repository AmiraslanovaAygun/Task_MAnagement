...
<div class="main-content" id="panel">
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 mt-3 shadow-none border-radius-xl bg-white" id="navbarTop" data-navbar="true" data-navbar-value="48">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <div class="bg-white border-radius-lg d-flex me-2">
                                ...
                                <button class="btn my-1 me-1 btn-primary">Search</button>
                            </div>
                        </div>
                    </div>
                </ul>
    ...
    </nav><?php /**PATH C:\Users\aygun\PhpstormProjects\TrelloApp\resources\views/front/partials/nav.blade.php ENDPATH**/ ?>